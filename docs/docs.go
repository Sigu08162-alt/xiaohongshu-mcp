...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/feeds/comment/like": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "点赞评论请求参数",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.LikeCommentRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.ReplyCommentRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.FeedDetailRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.FavoriteFeedRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.LikeFeedRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/feeds/search": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "搜索关键词(GET)",
                        "name": "keyword",
                        "in": "query"
                    },
                    {
                        "description": "搜索请求参数(POST)",
                        "name": "request",
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/main.SearchFeedsRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.PublishRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/publish_video": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "视频发布请求参数",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.PublishVideoRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/user/profile": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "用户主页请求参数",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.UserProfileRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "main.CommentLoadConfig": {
            "type": "object",
            "properties": {
                "click_more_replies": {
                    "description": "是否点击\"更多回复\"按钮",
                    "type": "boolean"
                },
                "max_comment_items": {
                    "description": "最大加载评论数（.parent-comment数量），0表示加载所有",
                    "type": "integer"
                },
                "max_replies_threshold": {
                    "description": "回复数量阈值，超过这个数量的\"更多\"按钮将被跳过（0表示不跳过任何）",
                    "type": "integer"
                },
                "scroll_speed": {
        ...
        "main.FeedDetailRequest": {
            ...
            "properties": {
                "comment_config": {
                    "$ref": "#/definitions/main.CommentLoadConfig"
                },
                "feed_id": {
                    "type": "string"
                },
        ...
        "main.SearchFeedsRequest": {
            ...
            "properties": {
                "filters": {
                    "$ref": "#/definitions/xiaohongshu.FilterOption"
                },
                "keyword": {
                    "type": "string"
                }
    ...
    "tags": [
        {
            "description": "登录状态管理和认证相关接口",
            "name": "登录认证"
        },
        {
            "description": "发布图文和视频笔记",
            "name": "内容发布"
        },
        {
            "description": "浏览和搜索小红书内容",
            "name": "内容发现"
        },
        {
            "description": "获取用户资料和主页信息",
            "name": "用户信息"
        },
        {
            "description": "评论、点赞、收藏等互动操作",
            "name": "内容互动"
        }
    ]
}`
