...
func (g *Gateway) GetContentAnalytics(ctx context.Context, limit int, sortBy, sortOrder string) (any, error) {
...
func (g *Gateway) GetFanAnalytics(ctx context.Context, period string) (any, error) {
